...
int db_queue_count(void);
int db_chan_count(void);
void reconcile_variables(void);
void reconcile_states(void);
void assign_ef_bits(void);
void assign_delay_ids(void);
void gen_preamble(void);
void gen_var_decl(void);
void gen_defn_c_code(void);
void gen_global_c_code(void);
void gen_init_reg(void);
void gen_opt_defn(int opt, char *defn_name);
void connect_variable(Expr *ep);
void assign_next_delay_id(Expr *ep, int *delay_id);
...
Expr *find_state(char *name,    /* state name */
...
void traverseExprTree(Expr  *ep,        /* ptr to start of expression */
