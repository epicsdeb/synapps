...
void decl_stmt(int  type,       /* variable type (e.g. V_FLOAT) */
...
/* Option statement */
void option_stmt(char       *option, /* "a", "r", ... */
 ...
 */
void assign_single(char *name,      /* ptr to variable name */
...
void assign_subscr(char *name,      /* ptr to variable name */
 ...
 */
void assign_list(char   *name,          /* ptr to variable name */
 ...
 */
void monitor_stmt(char      *name,      /* variable name (should be assigned) */
...
/* Definition C code */
void defn_c_stmt(Expr *c_list /* ptr to C code */)
{
#ifdef  DEBUG
...
void global_c_stmt(Expr *c_list /* ptr to C code */)
{
 ...
 */
Expr *expression(int    type,       /* E_BINOP, E_ASGNOP, etc */
...
Expr *link_expr(Expr    *ep1,   /* beginning of 1-st structure or list */
