...
void fill_db_block(Chan *cp, int elem_num)
{
	Var		*vp;
...
void fill_state_block(Expr *sp, char *ss_name)
{
        Expr *ep;
...
void eval_state_event_mask(Expr *sp, bitMask *pEventWords, int numEventWords)
{
	int		n;
	Expr		*tp;
 ...
 */
void eval_event_mask(Expr *ep, bitMask *pEventWords)
{
	Chan		*cp;
	Var		*vp;
	int		n;
 ...
 */
void eval_event_mask_subscr(Expr *ep, bitMask *pEventWords)
{
	extern int	num_events;
