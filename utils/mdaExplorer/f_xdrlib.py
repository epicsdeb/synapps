...
class Unpacker:
    ...
    def __init__(self, data):
        self.reset(data)
        self.unpackFloatDict = {}
        self.unpackDoubleDict = {}
        self.unpackIntDict = {}
    ...
    def standard_unpack_farray(self, n, unpack_item):
        list = []
        for i in range(n):
    ...
    def unpack_farray(self, n, unpack_item):
        ...
        if (unpack_item == self.unpack_float):
            return self.unpack_farray_float(n)
        elif (unpack_item == self.unpack_double):
            return self.unpack_farray_double(n)
        elif (unpack_item == self.unpack_int):
            return self.unpack_farray_int(n)
        else:
            return self.standard_unpack_farray(n, unpack_item)
    ...
    def unpack_farray_int(self, n):
        ...
        i = self.__pos
        self.__pos = j = i+4*n
        return self.unpackIntDict[n](self.__buf[i:j])
